...
const obtieneAmigos = (data) => {
    ...
    data.forEach(doc => {
        ...
        informacion.setContent(doc.data().nombre +'       '+ doc.data().coordenadas.lat +' , '+ doc.data().coordenadas.lng+" <br> <img height='100px' width='100px' src='https://i.pinimg.com/originals/a6/26/90/a62690a205dab3f19082b30a8b41f8bc.png'>");
